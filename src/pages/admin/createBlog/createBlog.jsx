...
function CreateBlog() {
  ...
  // store image with the help of firebase
  const uploadImage = () => {
    if (!thumbnail) return;
      ...
      <div className="p-5" style={{
        ...
        <div className="mb-3">
          <input
            ...
            name="category"
            value= {blogs.catagoty}
            onChange={(e) => setBlogs({...blogs, catagoty: e.target.value})}
          />
        </div>

        {/* Four Editor  */}
        <Editor
          apiKey='ua9tg942i4msd7wbpgz5gpy1f3hib3pjzfp8xqoym0jbuubu'
